...
function OhmMenu() {
  ...
  return (
    ...
    // >
    //   <Button id="guru-menu-button" size="large" variant="contained" color="secondary" title="GURU" aria-describedby={id}>
    //     <SvgIcon component={InfoIcon} color="primary" />
    //     <Typography>BUY GURU</Typography>
    //   </Button>
    //
    ...
    //
    <Link
      href={`https://app.uniswap.org/#/swap?inputCurrency=${fraxAddress}&outputCurrency=${GURU_ADDRESS}`}
      target="_blank"
      rel="noreferrer"
    >
